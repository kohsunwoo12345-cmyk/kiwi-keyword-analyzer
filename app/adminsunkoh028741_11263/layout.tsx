...
export const VIDEO_NAV: NavItem[] = [
  ...
  //  제공사가 새 모델을 내놓으면 여기서 확인하고 등록한다 — 배포 없이 노드에 나타난다.
  { title: '모델 등록부', href: `${ADMIN_BASE}/model-sync`, icon: Boxes },
...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: '크레딧 단가 설정', href: `${ADMIN_BASE}/credit-pricing`, icon: Coins },
  ...
  },
  {
    ...
    items: [
      ...
      { title: '랜딩 DB·페이지', href: `${ADMIN_BASE}/landing-db`, icon: Database },
      { title: '랜딩 신청자 DB', href: `${ADMIN_BASE}/leads`, icon: Inbox },
      { title: '알림 발송 내역', href: `${ADMIN_BASE}/notify-log`, icon: BellRing },
