...
const META: Record<string, Meta> = {
  leads: {
    ...
    notes: [
      '코딩 없이 폼 필드를 끌어다 놓기만 하면 랜딩페이지가 완성됩니다.',
      '어떤 채널에서 몇 명이 전환됐는지 실시간 대시보드로 확인합니다.',
      '중복·오타 번호를 자동으로 걸러 깨끗한 DB만 남깁니다.',
      '수집 즉시 CRM 파이프라인으로 넘어가 곧바로 영업할 수 있습니다.',
    ],
  },
  youtube: {
    tagline: '떡상할 콘텐츠를 데이터로 찾다',
    stats: [
    ...
    notes: [
      '구독자·조회수 추이를 한눈에 보고 성장 변곡점을 포착합니다.',
      '영상마다 노출·클릭·시청 지속률을 세밀하게 뜯어봅니다.',
      '지금 뜨는 키워드를 찾아 다음 떡상 콘텐츠를 기획합니다.',
      '경쟁 채널의 전략을 벤치마킹해 격차를 좁힙니다.',
    ],
  },
  blog: {
    ...
    notes: [
      '내 블로그의 현재 지수와 성장 여력을 등급으로 진단합니다.',
      '노리는 키워드가 상위노출 가능한지 확률로 알려줍니다.',
      '경쟁 문서 수와 강도를 계산해 승산 있는 키워드를 고릅니다.',
      '네이버 알고리즘에 맞춘 개선 리포트를 제공합니다.',
    ],
  },
  team: {
    tagline: '팀워크에 AI를 더하다',
    stats: [
    ...
    notes: [
      '업무를 카드로 만들어 진행 상황을 팀 전체가 공유합니다.',
      'AI가 카피·기획·분석을 즉석에서 도와줍니다.',
      '카드마다 코멘트와 멘션으로 빠르게 소통합니다.',
      '담당자와 마감을 규칙에 따라 자동으로 배정합니다.',
    ],
  },
  crm: {
    tagline: '수집한 DB를 매출로 바꾸다',
    stats: [
    ...
    notes: [
      '신규부터 계약까지 고객을 단계별로 관리합니다.',
      '조건에 맞는 고객을 그룹으로 묶어 정밀하게 공략합니다.',
      '조건이 충족되면 문자·알림톡이 자동으로 발송됩니다.',
      '고객 생애가치와 전환율을 리포트로 확인합니다.',
    ],
  },
  ads: {
    ...
    notes: [
      '메타·구글·네이버 광고를 하나의 화면에서 모니터링합니다.',
      '광고비 대비 매출과 전환당 비용을 실시간 추적합니다.',
      '어떤 소재가 잘 먹히는지 나란히 비교합니다.',
      'AI가 예산을 어디에 더 쓸지 제안합니다.',
    ],
  },
  video: {
    ...
    notes: [
      '한 줄 프롬프트만 입력하면 영상이 만들어집니다.',
      '전문가급 카메라 워크를 프리셋으로 적용합니다.',
      '숏폼·광고용 템플릿으로 즉시 완성합니다.',
      '브랜드 톤을 학습해 일관된 스타일을 유지합니다.',
    ],
  },
}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-[var(--text-soft)]">
                        {meta.notes[i] ?? '핵심 마케팅 워크플로우를 더 빠르고 정확하게 만들어줍니다.'}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-4xl px-5">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-[var(--text-soft)]">
              {slug === 'leads'
                ? '아래 폼은 실제로 동작합니다. 입력하면 DB가 수집됩니다.'
                : '아래 데모로 기능의 흐름을 미리 경험해보세요.'}
            </p>
          </Reveal>
