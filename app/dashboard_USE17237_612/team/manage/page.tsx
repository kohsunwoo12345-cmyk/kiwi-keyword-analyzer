...
function RoleBadge({ role }: { role: string }) {
  const map: Record<string, { cls: string; Icon: typeof Crown }> = {
    owner: { cls: 'border-amber-200 bg-amber-50 text-amber-700', Icon: Crown },
    admin: { cls: 'border-sky-200 bg-sky-50 text-sky-700', Icon: Shield },
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="card p-5">
              ...
              {needPlan && (
                <div className="mt-3 flex flex-col gap-1 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
                    ...
                    >
                      ...
                      <div className="flex flex-shrink-0 gap-2">
                        ...
                        <button
                          ...
                          disabled={respondBusy[inv.id]}
                          className="inline-flex items-center gap-1 rounded-lg border border-[var(--border)] px-3 py-1.5 text-xs font-semibold text-[var(--text-soft)] transition hover:bg-slate-50 disabled:opacity-50"
                        >
                          <X size={13} />거절
                        </button>
                      </div>
