...
const PALETTE = [
  { bg: 'bg-amber-500/12', border: 'border-amber-500/30', tape: 'bg-amber-200' },
  { bg: 'bg-rose-500/12', border: 'border-rose-500/30', tape: 'bg-rose-200' },
  { bg: 'bg-sky-500/12', border: 'border-sky-500/30', tape: 'bg-sky-200' },
  { bg: 'bg-emerald-500/12', border: 'border-emerald-500/30', tape: 'bg-emerald-200' },
  { bg: 'bg-violet-500/12', border: 'border-violet-500/30', tape: 'bg-violet-200' },
]
