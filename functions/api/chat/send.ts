...
function cannedReply(text: string): string {
  ...
  if (has(/환불|영수증|세금계산서|결제.?(안|오류|실패|취소)|입금|refund|invoice|receipt|billing/)) {
    return ko
      ? '결제·환불·세금계산서 관련은 담당자 확인이 필요해요. cs@nextbygency.com 로 주문 정보와 함께 문의 주시면 신속히 처리해 드리겠습니다.'
      : 'For payment, refund, or tax-invoice matters, please email cs@nextbygency.com with your order details and we’ll help you right away.'
  }
  // 요금 · 가격 · 플랜
  if (has(/요금|가격|비용|얼마|플랜|가입비|price|cost|pricing|plan|fee/)) {
    return ko
      ? 'BYGENCY 요금제 안내드릴게요 😊\n· 마케터: Plus 29,000원 / Pro 89,000원 / Max 249,000원 (월)\n· AI 영상 제작: Plus 49,000원 / Pro 149,000원 / Max 390,000원 (월)\n카드 없이 무료로 가입해 체험하실 수 있어요. 자세한 내용은 nextbygency.com/pricing 을 참고해 주세요!'
      : 'Here are our plans 😊\n· Marketer: Plus ₩29,000 / Pro ₩89,000 / Max ₩249,000 per month\n· AI Video: Plus ₩49,000 / Pro ₩149,000 / Max ₩390,000 per month\nYou can sign up free without a card. See nextbygency.com/pricing for details!'
  }
  // AI 영상 · 스튜디오
  ...
  if (has(/가입|회원|로그인|비밀번호|계정|signup|sign up|log ?in|password|account/)) {
    return ko
      ? '가입은 nextbygency.com/signup 에서 카드 없이 무료로 하실 수 있어요. 비밀번호는 로그인 후 프로필 페이지에서 변경 가능하고, 문제가 있으면 cs@nextbygency.com 로 알려주세요.'
      : 'Sign up free (no card) at nextbygency.com/signup. You can change your password on the profile page after logging in — any issues, email cs@nextbygency.com.'
  }
  // 도입 · 상담 · 견적 · 엔터프라이즈
  if (has(/도입|상담|영업|견적|대량|엔터프라이즈|계약|제휴|sales|enterprise|quote|demo/)) {
    return ko
      ? '도입·대량 사용·제휴 상담은 cs@nextbygency.com 또는 nextbygency.com/contact 로 남겨주시면 담당자가 빠르게 안내드리겠습니다.'
      : 'For enterprise, bulk usage, or partnership inquiries, reach us at cs@nextbygency.com or nextbygency.com/contact and our team will follow up quickly.'
  }
  // 기능 문의
  ...
  // 기본
  return ko
    ? '문의 주셔서 감사합니다! 조금 더 자세히 알려주시면 정확히 안내드릴게요. 급하시면 cs@nextbygency.com 또는 nextbygency.com/contact 로 문의 주시면 담당자가 도와드립니다.'
    : 'Thanks for reaching out! Tell us a bit more and we’ll help precisely. For anything urgent, contact cs@nextbygency.com or nextbygency.com/contact and our team will assist you.'
}
